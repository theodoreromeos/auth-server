...
@Component
public class MobilityAppUsernamePwdAuthenticationProvider implements AuthenticationProvider {

    private final MobilityAppUserDetailsService mobilityAppUserDetailsService;
